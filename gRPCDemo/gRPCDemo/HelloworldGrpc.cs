...
namespace GRPCDemo {
  public static partial class gRPC
  {
    ...
    static readonly grpc::Marshaller<global::GRPCDemo.list1> __Marshaller_gRPCDemo_list1 = grpc::Marshallers.Create((arg) => global::Google.Protobuf.MessageExtensions.ToByteArray(arg), global::GRPCDemo.list1.Parser.ParseFrom);
    ...
    static readonly grpc::Method<global::GRPCDemo.HelloRequest, global::GRPCDemo.list1> __Method_Getlsit = new grpc::Method<global::GRPCDemo.HelloRequest, global::GRPCDemo.list1>(
        grpc::MethodType.Unary,
        __ServiceName,
        "Getlsit",
        __Marshaller_gRPCDemo_HelloRequest,
        __Marshaller_gRPCDemo_list1);
    ...
    public abstract partial class gRPCBase
    {
      ...
      public virtual global::System.Threading.Tasks.Task<global::GRPCDemo.list1> Getlsit(global::GRPCDemo.HelloRequest request, grpc::ServerCallContext context)
      {
        throw new grpc::RpcException(new grpc::Status(grpc::StatusCode.Unimplemented, ""));
      }
    ...
    public partial class gRPCClient : grpc::ClientBase<gRPCClient>
    {
      ...
      public virtual global::GRPCDemo.list1 Getlsit(global::GRPCDemo.HelloRequest request, grpc::Metadata headers = null, global::System.DateTime? deadline = null, global::System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
      {
        return Getlsit(request, new grpc::CallOptions(headers, deadline, cancellationToken));
      }
      public virtual global::GRPCDemo.list1 Getlsit(global::GRPCDemo.HelloRequest request, grpc::CallOptions options)
      {
        return CallInvoker.BlockingUnaryCall(__Method_Getlsit, null, options, request);
      }
      public virtual grpc::AsyncUnaryCall<global::GRPCDemo.list1> GetlsitAsync(global::GRPCDemo.HelloRequest request, grpc::Metadata headers = null, global::System.DateTime? deadline = null, global::System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
      {
        return GetlsitAsync(request, new grpc::CallOptions(headers, deadline, cancellationToken));
      }
      public virtual grpc::AsyncUnaryCall<global::GRPCDemo.list1> GetlsitAsync(global::GRPCDemo.HelloRequest request, grpc::CallOptions options)
      {
        return CallInvoker.AsyncUnaryCall(__Method_Getlsit, null, options, request);
      }
    ...
    public static grpc::ServerServiceDefinition BindService(gRPCBase serviceImpl)
    {
      return grpc::ServerServiceDefinition.CreateBuilder()
          ...
          .AddMethod(__Method_Getlsit, serviceImpl.Getlsit).Build();
    }
    ...
    public static void BindService(grpc::ServiceBinderBase serviceBinder, gRPCBase serviceImpl)
    {
      ...
      serviceBinder.AddMethod(__Method_Getlsit, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::GRPCDemo.HelloRequest, global::GRPCDemo.list1>(serviceImpl.Getlsit));
    }
